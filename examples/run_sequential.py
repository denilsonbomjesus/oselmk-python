...
def _parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="OS-ELMK sequential (incremental) online update.")
...
def main() -> None:
    ...
    print(f"[info] Online stream : {len(y_stream)} samples  (block_size = {args.block_size})")
    ...
    print(f"[info] Online updates  — {n_updates} block(s)  (total {t_update_total:.4f} s)")
